...
func (c *Swiftness) WriteXML(w http.ResponseWriter, status int, data interface{}, headers ...http.Header) error {
...
func (c *Swiftness) DownloadFile(w http.ResponseWriter, r *http.Request, pathToFile, fileName string) error {
