...
func (c *Swiftness) RandomString(n int) string {
...
func (c *Swiftness) CreateDirIfNotExist(path string) error {
	const mode = 0755
...
func (c *Swiftness) CreateFileIfNotExists(path string) error {
